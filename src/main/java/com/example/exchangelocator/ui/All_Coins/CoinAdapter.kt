...
class CoinAdapter : RecyclerView.Adapter<CoinAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: TheCoinBinding) :
        ...
        fun bind(coin: CoinDetail, isNew: Boolean = false) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = TheCoinBinding.inflate(LayoutInflater.from(parent.context), parent, false)
